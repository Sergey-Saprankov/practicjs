...
var modal = function modal() {
  var bindModal = function bindModal(modalWindowSelector, opnBtnSelector, clsBtnSelector) {
    var openModal = document.querySelectorAll(opnBtnSelector);
    var popap = document.querySelector(modalWindowSelector);
    var closeBtn = popap.querySelector(clsBtnSelector);
    openModal.forEach(function (el) {
      el.addEventListener('click', function (e) {
        ...
        popap.style.display = 'block'; // document.body.classList.add('modal-open');

        document.body.style.overflow = 'hidden';
      });
    });
    closeBtn.addEventListener('click', function () {
      popap.style.display = 'none'; // document.body.classList.remove('modal-open');
  ...
  bindModal('.popup', '.phone_link', '.popup .popup_close'); // showModalByTime('.popup', 60000);
};
...
var tabs = function tabs(container, tab, content, activeClass) {
  var containerTabs = document.querySelector(container);
